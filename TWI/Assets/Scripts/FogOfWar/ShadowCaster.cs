...
using System.Collections.Generic;
    public static class ShadowCaster
    {
        ...
        public static void ComputeFieldOfViewWithShadowCasting(
            int x, int y, int radius, int mapWidth, int mapHeight,
        ...
        private static void ComputeFieldOfViewInOctantZero(
			int radius, int mapWidth, int mapHeight,
			Func<int, int, bool> isOpaque,
            ...
            Queue<ColumnPortion> queue)
        {
            ...
            for (int y = topY; y >= bottomY; --y)
            {
				...
				bool inMap = IsWithinMap(x, y, mapWidth, mapHeight);
                if (inRadius && inMap)
                {
                ...
                bool currentIsOpaque = !inMap || !inRadius || isOpaque(x, y);
